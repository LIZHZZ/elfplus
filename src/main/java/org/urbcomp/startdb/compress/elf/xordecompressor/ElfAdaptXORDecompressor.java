...
public class ElfAdaptXORDecompressor {
    ...
    public ElfAdaptXORDecompressor(byte[] bs) {
    ...
    private void nextValue() throws IOException {
        ...
        switch (flag) {
            ...
            case 2:
                ...
                centerBits = leadAndCenter & 0xf + storedCenterBits - windowSize;
                if (centerBits == 0) {
                    centerBits = storedCenterBits + windowSize * 2;
                }
                storedTrailingZeros = 64 - storedLeadingZeros - centerBits;
                value = ((in.readLong(centerBits - 1) << 1) + 1) << storedTrailingZeros;
                value = storedVal ^ value;
